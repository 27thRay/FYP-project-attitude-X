...
if __name__ == '__main__':
    ...
    file_path_job = "sample_data/job_description.pdf"
    file_path_resume = "sample_data/Resume_2.pdf"
    ...
    print('RESUME TEXT FILTER:')
    print(resume_text_filter)
    jd_text_filter = filter_stopwords(jd_text)
    print('JD TEXT FILTER')
    print(jd_text_filter)
